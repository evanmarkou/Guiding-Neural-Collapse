...
from nc.optimisers.pymanopt.gpu.tools import bisect_sequence, unpack_singleton_sequence_return_value
from nc.optimisers.pymanopt.gpu.autodiff.backends._backend import Backend
...
class PyTorchBackend(Backend):
    ...
    def generate_gradient_operator(self, function, num_arguments):
        def gradient(*args):
            arguments = [
                arg.requires_grad_() for arg in args
            ]
