...
from nc.optimisers.pymanopt.cpu.manifolds.manifold import RiemannianSubmanifold
from nc.optimisers.pymanopt.cpu.tools import extend_docstring
from nc.optimisers.pymanopt.cpu.tools.multi import (
    multiexpm,
    multihconj,
    multiherm,
    multilogm,
